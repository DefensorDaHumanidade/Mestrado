...
É possível constatar que a questão de número 6 (seis) é a questão com menor taxa de satisfação. Durante o grupo focal, muitas crianças manifestaram que consideraram o jogo muito fácil. Por tanto, atribui-se uma menor pontuação a essa questão. 

A média da idade do grupo experimental é de 7,87 enquanto a média de idade do grupo controle é de 8,19 anos. A média da idade do grupo experimental é de 7,87 enquanto a média de idade do grupo controle é de 8,19 anos. A média da idade do grupo experimental é de 7,87 enquanto a média de idade do grupo controle é de 8,19 anos. 
