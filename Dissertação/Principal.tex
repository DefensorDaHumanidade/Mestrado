...
\documentclass[							% Descrição
	...
	%draft,								% Inserir isso remove as imagens
	%demo,								% Inserir isso BLOQUEIA as imagens de serem vistas
...
\orientador[Orientadora:]{Carla {}Diacui M. Berkenbrock}%
...
\include{PreTextuais/Epigrafe}				% Elemento Opcional (necessita de fonte bibliográfica)
...
\include{Textuais/Capitulo1}
\include{Textuais/Capitulo2}
\include{Textuais/Capitulo3}
\include{Textuais/Capitulo4}
\include{Textuais/Capitulo5}
\include{Textuais/Capitulo6}
