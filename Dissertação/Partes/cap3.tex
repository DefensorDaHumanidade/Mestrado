...
O Abuso Sexual Infantil (ASI) maninesta-se como um problema global. Diante disso, profissionais da saúde e pesquisadores passaram a se dedicar a compreender as raízes  deste mal que assola milhares de crianças todos os anos \cite{deslandes1994atenccao, dahlberg2006violencia, da2017violencia}. Dentre os métodos de causa e efeito, cita-se a Análise de Causa Raiz (ACR). Tal método visa descobrir a causa de um problema para identificar soluções adequadas \cite{rooney2004root}. A área de criminologia em específico, comporta uma série de teorias acerca das causas para os atos infracionais. Dentre elas, destaca-se a Teoria da Atividade Rotineira, ilustrada na a \autoref{fig:Crime}.


\begin{figure}[htb]
    \begin{minipage}{0.5\textwidth}
      O infográfico da \autoref{fig:Crime} apresenta os três elementos básicos da Teoria da Atividade Rotineira, também conhecida como de Triângulo do Crime. Em resumo, três elementos são considerados essenciais para a ocorrência de um crime. Para que um crime aconteça deve-se haver um criminoso motivado sem supervisão, um lugar sem fiscalização e um vítima desprotegida
...
O infográfico da \autoref{fig:Crime} apresenta os três elementos básico da Teoria da Atividade Rotineira, também denominada de Triângulo do Crime. Em resumo, três elementos são considerados essenciais para a ocorrência de um crime. 

Um criminoso sem monitoramento
Um lugar sem fiscalização
Vítima sem proteção

\cite{eck1995examining}


Como resultado, fatores de risco foram elencadas pelas pesquisas na área. Eu eu eu eu 
...
\begin{figure}[htb]
	\caption{\label{fig:GraficoHistorico}Fatores de Risco}
  \begin{center}
    \includegraphics[width=\linewidth]{./Figuras/FatoresRisco.pdf}
	\end{center}
...
[na literatura médica esse à a prevenção quartenaria, contudo ela não se aplica a estes casos de abuso]

A Teoria do Triângulo do Crime, também conhecida como Triângulo de Análise de Problema, tem sua origem em uma das principais teorias da criminologia do ambiente – a Teoria da Atividade Rotineira. %Routine activity theory
...
[cada uma desses tecnicas abala o Triangulo do Crime de alguma forma, dificultando os abusos] %https://www.graberalarmes.com.br/como-se-proteger-do-triangulo-do-crime/


focadas na mitigação 

no enfretamento e na redução do número de crianças violentadas sexualmente. 

\begin{figure}[htb]
	\caption{\label{fig:GraficoHistorico}Níveis de Prevenção}
  \begin{center}
...
testo ahahahah ahaha 
\newpage

\section{Teste $\includegraphics[width=0.05\linewidth]{./Figuras/Prevencao1.pdf}$$\includegraphics[width=0.05\linewidth]{./Figuras/Prevencao2.pdf}$$\includegraphics[width=0.05\linewidth]{./Figuras/Prevencao3.pdf}$}\label{sec:teste}
