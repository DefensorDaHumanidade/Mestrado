...
Os materiais didáticos vem de modo a aprimorar o processo pedagógico. Os matriais funcionam não apenas como um instrumento facilitador do aprendizado infantil, mas também como uma ferramenta de auxílio aos professores. Entre os materiais didáticos de maior predominância ao longo da história, estão os livros\footnote{\textit{My Body Is Private} (1984)}.
...
Jogos sério são utilizados no processo ensino-pedagógico desde o início da década de 1970. A partir de então, diversos estudos foram conduzidos de modo a identificar os reais impactos que tais jogos tinham no ensino infantil e juvenil \cite{dip2016advancing}. Ao longo dos anos, cientistas e pesquisadores concluiram que a utilização de jogos em sala de aula desencadeava um aumento expressivo no desempenho escolar dos estudantes \cite{wentzel1998social}. O aumento se acentuava mais nas disciplinas relacionadas, de alguma forma, aos conteúdos minitrados pelo jogo. 
...
%\subsubsection{Teste}\label{sssec:Orbit}
