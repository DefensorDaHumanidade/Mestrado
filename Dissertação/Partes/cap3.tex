...
O sistema juridico agindo de forma altamente punitiva, criando leis e penas cada vez mais severas, \cite{Camila2019}
...
A atração do menores de idade é vista como uma parafilia, por isso, a prisão do agresssor sexual (seja em presídio ou em clínica) é em alguns casos, acompanhada de tratamento médico. 

[Treatment of Offenders] = Gestão de Infratores \cite{mendelson2015parent}
...
[Mental Health Treatment] = terapias e tratamentos para criminosos\cite{finkelhor2009prevention}

[Offender Registration] = Dados de criminosos já soltos guardando seus registros (mais fácil de fazer a busca em caso e reincidência)



%atualiza o Estatuto da Criança e do Adolescente (ECA — Lei 8.069, de 1990) para determinar que o juiz, ao verificar a hipótese de maus-tratos, opressão ou abuso sexual cometidos pelos pais ou responsáveis, poderá determinar como medida cautelar, além do afastamento do agressor da residência, também o seu ingresso em programas de recuperação, reeducação e prevenção de violência contra crianças ou adolescentes.
