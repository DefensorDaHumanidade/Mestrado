...
\section{Metodologia Avaliativa}\label{sec:Engenharia}
...
%https://www.br-ie.org/pub/index.php/wie/article/view/8582/6143#


Por se tratar de um jogo digital educativo, a metodologia escolhida para o desenvolvimento do jogo foi a GAMED (diGital educAtional gaMe dEvelopment methoDology) \cite{aslan2015gamed}. Tal metodologia, segundo os autores, tambem pode ser utilizada para a realizacao de projetos menores, atraves da reducao de algumas etapas para a execucao do projeto em um perıodo menor.
...
A execuc¸ao da primeira fase se deu atrav ˜ es de discuss ´ oes ˜ realizadas em uma disciplina de Informatica na Educac¸ ´ ao, ˜ na qual foi solicitada a criac¸ao de um jogo educativo.

Ja para a segunda fase, foram escolhidos os principais requisitos que compoem o jogo, al ˜ em da ´ engine Godot com a utilizac¸ao do GDScript para a criac¸ ˜ ao da l ˜ ogica do jogo.

A etapa de implementac¸ao do jogo foi realizada atrav ˜ es´ da metodologia de desenvolvimento agil XP. [14] aponta ´ que tal metodologia e possivelmente uma das mais utilizadas ´ para desenvolvimento agil, na qual o ´ software e desenvolvido ´ interativamente atraves de ´ releases. Cada release engloba um conjunto de user stories (requisitos) que serao implementados, ˜ testados e acoplados ao sistema. Desta maneira, para o desenvolvimento do DinQuiz, cada release durava o per´ıodo de uma semana, sendo apresentados os seus resultados durante o encontro semanal da disciplina. A realizac¸ao dos testes e ˜ validac¸ao de cada ˜ release se dava atraves de um execut ´ avel ´ que continha o jogo.

Por fim, apos desenvolvidas algumas interac¸ ´ oes do jogo, sua ˜ apresentac¸ao e avaliac¸ ˜ ao foram realizadas para/pelo grupo dis- ˜ cente da disciplina, do Curso de Engenharia de Computac¸ao, ˜ processo que contribuiu para a sua construc¸ao e poss ˜ ´ıveis melhorias de implementac¸ao. O jogo foi tamb ˜ em apresentado ´ a crianc¸as de uma escola publica da cidade de Feira de ´ Santana, nesta fase inicial, para nao s ˜ o conversar sobre a ´ educac¸ao financeira, como tamb ˜ em para levantar as primeiras ´ impressoes, sugest ˜ oes e indicac¸ ˜ oes de melhorias.

O desenvolvimento de um jogo na forma de software para aprendizagem baseada em jogos apresenta desafios técnicos significativos para educadores, pesquisadores, designers de jogos e engenheiros de software. O desenvolvimento do jogo consiste em um conjunto de processos complexos que requerem conhecimento multifacetado em várias disciplinas, como design gráfico digital, educação, jogos, design instrucional, modelagem e simulação, psicologia, engenharia de software, artes visuais e a área de aprendizagem. O planejamento e o gerenciamento de um projeto de desenvolvimento multidisciplinar tão complexo exigem uma metodologia unificadora e não devem ser executados de maneira ad hoc. Este artigo apresenta uma metodologia denominada GAMED (diGital educAtional gaMe dEvelopment methoDology). O GAMED consiste em um corpo de métodos, regras e postulados e está inserido em um ciclo de vida de um jogo educacional digital. O ciclo de vida descreve uma estrutura para a organização das fases, processos, produtos de trabalho, atividades de garantia de qualidade e atividades de gerenciamento de projeto necessárias para desenvolver, usar, manter e desenvolver um jogo educacional digital do nascimento à aposentadoria. O GAMED fornece uma abordagem modular estruturada para superar a complexidade do desenvolvimento e orienta os desenvolvedores durante todo o ciclo de vida.
