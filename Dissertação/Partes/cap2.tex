...
Os jogos sérios proporcionam um sistema de aprendizagem interativa. A aprendizagem interativa é um processo didático de ensino mais atrativo aos Nativos Digitais\footnote{Nativos Digitais é o termo utilizado para descrever as pessoas familiarizadas com as tecnologias digitais, pois nasceram posteriormente a popularização e a difusão global destas mesmas tecnologias.}. Os nativos digitais apresentam maior preferencia por abordagens interativas baseadas em processos de tentativas e erro \cite{pescador2010tecnologias}. Além disso, os nativos digitais já nascem imersos no mundo digital, o que torna para eles, o processo de iteração com artefatos digitais, um processo mais natural e orgânico, em comparação a iteração entre tais artefatos e os Imigrantes Digitais\footnote{Imigrantes Digitais é o termo usado para definir as pessoa nascidas ou criadas antes do uso generalizado das tecnologias digitais.}.
...
O mercado de jogos movimenta bilhões de reais todos os anos ao redor do mundo. A indústria de desenvolvimento de jogos acompanha essa cifra trazendo cada vez mais pessoas capacitadas para a produção e desenvolvimento de jogos. Em alguns casos o processo de desenvolvimento de um jogo pode envolver milhares de pessoas e levar anos até ser finalizado. Em contrapartida há ainda os jogos de carater independente (\textit{indie game}) que acabam por ser jogos mais modestos em termos de desenvolvimento, se limitando a equipes pequenas, podendo ser produzidos em pouco tempo, ou não. Essa discrepância entre os jogos resulta em uma quantidade variadade de metodogogias voltadas para o desenvolvimento de jogos.


As metodologias para o desenvolvimento de jogos variam a depender de uma série de fatores. Entratanto, três questões principais são levadas em consideração no momento da escolha por uma metodologia: quantidade de envolvidos no projeto, prazo da entrega e recursos necessários. Embora muitos estudos tenham sido publicados sobre o desenvolvimento de jogos educativos, existem poucas metodologias sólidas e eficazes nesta área \cite{aslan2015gamed}. 

O processo de desenvolvimento do jogo sério proposto pelo presente trabalho para compor um programa de prevenção a violência sexual infantil se baseia em um metodologia sólida e eficaz voltada para o desenvolvimento de jogos educativos digitais denominada de GAMED (diGital educAtional gaMe dEvelopment methoDology) \cite{aslan2016digital}. 


A metodologia GAMED é uma das poucas metodologia encontradas voltadas para o desenvolvimento de jogos educacionais digitais, podendo ser aplicada tanto para grandes ou pequenos projetos. O GAMED apresenta alta qualidade, baixo risco de falhas e alta probabilidade de que o jogo seja concluído dentro do orçamento e prazos estabelecidos \cite{aslan2015gamed}. Além disso, o GAMED fornece uma abordagem modular estruturada para superar a complexidade do desenvolvimento e orienta os desenvolvedores durante todo o ciclo de desenvolvimento do jogo.
...
O GAMED é uma metodologia que se incrementa a cada ciclo de desenvolvimento. Ao final de cada ciclo há a entrega de um jogo operacional, por tal razão o GAMED pode ser classificado como um método agil de desenvolvimento. O GAMED é constituido por quatro fases principais: Fase de Projeto, Fase de Projeto de Software, Fase de Desenvolvimento/Publicação e Fase de Realimentação. As fases são subdivididas em etapa, cada etapa consiste de um processo. A \autoref{fig:GAMED} apresenta um esquema com os principais elementos requeridos no GAMED. 
...
A primeira fase do GAMED (\textbf{Fase de Projeto}) estabelece a definição de uma problema no domínio educacional para ser abordado por meio da dinâmica de jogos. O  atual trabalho acadêmico se objetiva a fortaceler as estratégias de enfretamento ao problema da violência sexual infantil. Para tal razão, foi realizada uma formulação do problema, identidicando suas causas e consequência, além da crianção conceitual do jogo. Na segunda fase do GAMED (\textbf{Fase de Projeto de Software}); referente ao jogo produzido por este trabalho; foram catalogados os requisitos necessários para o desenvolvimento do jogo, além da escolha da arquitetura a ser utilizada. Um documento de requisitos é produzido nesta etapa. A terceira fase do GAMED (\textbf{Fase de Desenvolvimento/Pulicação}), remente especificamente ao processo de criação e desenvolvimento do jogo. O jogo deve ser produzido nesta etapa de modo a sempre disponizar ao final uma versão jogavel. A quarta fase do GAMED (\textbf{Fase de Realimentação}), busca apresentar um jogo brevemente finalizado a estudantes ou professores. O intuito é identificar falhas ou eventuais melhorias que podem vir a serem relatadas. Nesta etapa o jogo pode ser apresentado a outros profissionais devidamente capacitados que não precisam necessaria contemplar o público alvo do jogo.

O GAMED fornece um plano detalhado para o gerenciamento de projetos complexos de desenvolvimento de jogos. Sua estrutura modularizada de desenvolvimento em fases e processos facilita o desenvolvimento de jogos educacionais digitais. O GAMED ainda é flexível se adapatando as necessidades da equipe de desenvolvimento 
\cite{aslan2016digital}. Como o desenvolvimento do jogo sério deste trabalho envolveu essencialmente uma pessoa (o próprio pesquisador) algumas etapas do GAMED foram suprimadas afim de agilizar o processo de desenvolvimento, porém sem perder sua essencia primordial. 
...
A avaliação de jogos é utilizada para medir o nível de sucesso de uma solução educacional, ou seja, se ela possibilita alcançar os objetivos que foram estabelecidos. Existem inúmeros métodos e modelos para avaliação de jogos mp contexto educacional, no entanto, a maioria das soluções avaliativas oferecidas a crianças no ensino fundamental, não estão amplamente disponíveis \cite{tutty2019children}. Voltado a prevenção da violência sexual infantil o modelo avaliativo de maior presenção nos programas com essa temática é o \textit{Children’s Knowledge of Abuse Questionnaire} (CKAQ).

O \textit{Children’s Knowledge of Abuse Questionnaire} é um questionário de 40 questões (CKAQ40) original foi desenvolvido para avaliar os níveis de conhecimento dos conceitos de prevenção de abuso para crianças em idade escolar do primeiro ao sexto ano \cite{tutty1992ability}.

%O questionário foi construída  para avaliar o quão bem crianças de 5 a 12 anos aprendem conceitos de prevenção de abuso sexual. Uma extensa revisão de programas de prevenção de abuso infantil e pesquisas forneceram informações para a construção de itens. O C.K.A.Q. foi projetado para que crianças sem exposição anterior a materiais de prevenção pudessem entender as perguntas. As instruções descrevem toques bons, ruins e confusos, pois, sem essas informações, as perguntas não poderiam ter sido compreendidas por crianças sem exposição prévia aos conceitos de prevenção. Deve-se notar, no entanto, que as informações contidas nas instruções constituem uma mini-aula sobre prevenção e podem ter influenciado as pontuações das crianças no uso subsequente da medida. A importância de utilizar o presente desenho de pesquisa em que os efeitos de um pré-teste podem ser estimados é, portanto, enfatizada.

%O C.K.A.Q. originalmente consistia em 35 itens verdadeiros / falsos, no entanto, outros cinco itens mais “complexos” foram adicionados para crianças nas séries 3 e 6, para evitar preocupações sobre um possível efeito de teto. Embora o C.K.A.Q. testa uma ampla gama de idades, há um precedente para o uso da mesma medida para crianças tanto na 1ª quanto na 6ª série (Saslawsky \& Wurtele, 1985). Além disso, como as crianças participam do mesmo programa de prevenção, é interessante identificar se as crianças mais novas aprendem os mesmos conceitos que os mais velhos. Para compensar a falta de capacidade de leitura das crianças mais novas, o C.K.A.Q. foi administrado verbalmente às crianças da 1ª série e do jardim de infância individualmente. Para garantir resultados comparáveis, o teste também foi administrado verbalmente a crianças nas séries mais avançadas, permitindo comparações entre idades nas questões de pesquisa de interesse.

%O C.K.A.Q. começa com itens gerais sobre assertividade com colegas, toque não sexual e atitudes em relação a estranhos. Essas áreas são relativamente familiares para as crianças e visavam estabelecer uma resposta confortável ao questionário. Os itens relacionados ao abuso sexual e à possibilidade de que pessoas familiares possam tocar as crianças de maneira confusa ou incômoda foram situados no final da medida. Um aspecto final do C.K.A.Q. é a inclusão de itens sobre toque positivo. Uma grande preocupação expressa por professores e pais sobre os materiais de prevenção do abuso infantil é que as crianças podem ficar constrangidas ao tocar e ser tocadas. Em recompensa, alguns adultos pararam de dar toques positivos para o caso de serem mal interpretados como avanços sexuais. Este é um efeito colateral infeliz e não intencional de muitos programas (Anderson, 1986). Tocar encoraja explicitamente dar e receber toques positivos apropriados.

%As análises do C.K.A.Q. as pontuações demonstram que as crianças que participaram do Programa de Prevenção do Abuso Infantil da Comunidade de Hamilton / Wentworth aprenderam os conceitos de prevenção ensinados em uma extensão significativamente maior do que as crianças de idades semelhantes que não assistiram à brincadeira. Ao examinar a melhoria média entre o pré e pós-teste para aqueles nas condições experimentais, pode-se perguntar por que essas diferenças, embora estatisticamente significativas, eram relativamente pequenas. A descoberta de melhorias pequenas, mas estatisticamente significativas após um programa de prevenção é consistente com os projetos de pesquisa bem elaborados que foram revisados ​​anteriormente (Saslawsky \& Wurtele, 1986; Wolfe et al., 1986). O fato de o efeito ser pequeno é compatível com a ideia de que os programas de prevenção não estão simplesmente transmitindo informações (caso em que se pode esperar um aumento muito maior), mas estão ensinando novas atitudes sobre como responder a outras pessoas; por exemplo, se é apropriado ser assertivo com colegas e adultos. As atitudes representam padrões de crenças de longa data (Kahle, 1984) que foram reforçados inúmeras vezes pela família e pela cultura e, portanto, são mais difíceis de mudar do que conhecimento ou informação. Além disso, é razoável esperar uma quantidade modesta de aprendizado de uma apresentação única de uma peça de 45 minutos.

%O CKAQ-33 foi usado em uma série de avaliações de programas de prevenção de CSA ou será no futuro (por exemplo, McElearney, Brennan-Wilson, Murphy, Stephenson, \& Bunting, 2018). Embora a maioria dos pesquisadores tenha usado a escala de 33 itens (Casper, 1999; Dunn, 2011; Hayward \& Pehrsson, 2000; Holloway \& Polido, 2018; Oldfield, Hays, \& Megel, 1996; Pulido et al., 2015), alguns usaram apenas a subescala de toque inadequado de 24 itens (Daigneault, Hébert, McDuff, \& Frappier, 2012); outros encurtaram a medida (Czerwinski, Finne, Kolip, \& Alfes, 2018; Müller, Rödera, \& Fingerle, 2014) ou a adaptaram com itens de outras medidas (Baker, Gleason, Naai, Mitchell, \& Trecker, 2013; Hébert, Lavoie, Piché, \& Poitras, 2001; Lee, McGee, \& Ungar, 2001).


%(Tutty, 1995) \cite{tutty1995revised}
