...
\begin{framed}
  \begin{parcolumns}{2}
    ...
    \colchunk{
    \begin{itemize}\item[$\checkmark$] Os participantes devem manifestar competências sobre o uso seguro das tecnologias da informação e comunicação. \end{itemize}
    \begin{itemize}\item[$\null$]\end{itemize}
