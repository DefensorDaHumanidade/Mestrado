...
\begin{figure}[htb]
	...
	\begin{center}
	    \includegraphics[width=0.85\textwidth]{./Figuras/Termos.pdf}
	\end{center}
...
\begin{parcolumns}{2}
\raggedright
\colchunk{\centering Abuso sexual \textbf{sem} contato físico:}
\colchunk{\centering Abuso sexual \textbf{com} contato físico:}
\colplacechunks
...
Os tipos de abuso sexual, indepentende de sua categoria, são punidos pela legislação brasileira. Eles podem ser legalmente tipificados em: rufianismo, corrupção de menor, assédio sexual e estupro de vulnerável. Destaca-se que diferentemente do crime de `estupro', que exige constrangimento mediante violência ou grave ameaça, o `estupro de vulnerável' é crime mesmo com o consentimento da vítima, sendo considerado vulnerável, menor de 14 anos ou pessoa incapacitada de oferecer resistência. 

%Existe contudo uma compreensão mais ampla de abuso sexual com contato físico que inclui contatos ``forçados'' como beijos e toques em outras zonas corporais erógenas \cite{santos2009guia, sayao2006refazendo}.

Os atos consumados de violência sexual física são capazes de sequelar suas vítimas tanto fisicamente, quanto emocionalmente. Além disso, a criança violentada pode chegar em sua fase adulta apresentado os mais variados transtornos e distrúbios \cite{lima2018violencia}. 
...
\begin{parcolumns}{2}
\raggedright
\colchunk{\centering Sequelas \textbf{físicas:}}
\colchunk{\centering Sequelas \textbf{psicológicos:}}
\colplacechunks
...
\colchunk{\begin{itemize}\item[$\circ$] \justify Masturbação compulsiva\end{itemize}}
...
\colchunk{\begin{itemize}\item[$\circ$] \justify Disfunção sexual\end{itemize}}
...
\colchunk{\begin{itemize}\item[$\bullet$] \justify enurese\end{itemize}}
