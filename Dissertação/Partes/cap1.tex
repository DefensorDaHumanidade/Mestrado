...
%The World Health Organization (WHO) defines child abuse and child maltreatment as "all forms of physical and/or emotional ill-treatment, sexual abuse, neglect or negligent treatment or commercial or other exploitation, resulting in actual or potential harm to the child's health, survival, development or dignity in the context of a relationship of responsibility, trust or power.” (1999; p.15).
...
\begin{wrapfigure}{r}{5.0cm}
  \vspace{-0.68cm}
  \caption{\label{fig:Tipificacao}Tipificação Nacional}
      \begin{center}
        \includegraphics[width=0.32\textwidth]{./Figuras/Violencia.pdf}
      \end{center}
      \legend{Fonte: Os autores (2020).}
\end{wrapfigure}

%\footnote{Lei nº 13.431. Disponível em: \url{http://www.planalto.gov.br/ccivil_03/_ato2015-2018/2017/lei/L13431.htm}}
\end{comment}
...
%A faixa etária da infância e adolescência são definidos no Estatuto da Criança e do Adolescente\footnote{ECA:\url{http://www.planalto.gov.br/ccivil_03/leis/l8069.htm}} (ECA). O ECA define como como criança, todo o indivíduo até doze anos de idade incompletos, e adolescente todo o indivíduo entre doze e dezoito anos de idade. A violência sexual é uma conduta criminosa definida na Lei nº 13.431\footnote{ECA:\url{http://www.planalto.gov.br/ccivil_03/_ato2015-2018/2017/lei/L13431.htm}}. A lei em questão, tipifica três formas de violência sexual: abuso sexual, exploração sexual comercial e tráfico de pessoas. 
...
\colchunk{\begin{itemize}\item[$\times$] \justify \textbf{Abuso sexual verbal:} consiste em conversas abertas sobre atividades sexuais, destinadas a despertar o interesse da criança ou chocá-la.\end{itemize}}
...
\colchunk{\begin{itemize}\item[$\bullet$] Infecções sexualmente transmissíveis\end{itemize}}
...
%%egry2018notificaccao = problema de saude publica. 
...
\begin{figure}[htb]
  ...
  %\end{center}
  \vspace{-1.0cm}
	\legend{Fonte: Agência O Globo (2020).}
\end{figure}
...
%Somado a isso, experimentos relatam inclusive uma maior retenção de conhecimento em grupos de crianças que jogaram tais jogos em relação a grupos que não jogaram \cite{muller2014child, fingerleabschlussbericht}.

%Pesquisas apontam inclusive que os programas tendem a ser mais eficazes quando permitem que as crianças pratiquem de forma ativa os ensinamentos adquiridos \cite{collin2013lessons}.

%The typical victims described were passive, troubled, lonely children from broken homes. \cite{budin1989sex}
%The subjects tended to prefer their own children and/or passive, quiet, troubled, Ionely children from broken homes.
...
\begin{figure}[htb]
  \caption{\label{fig:EUA}Taxas da violência sexual infantil nos Estados Unidos da América.}
  \vspace{-0.2 cm}
  \begin{center}
    \includegraphics[width=\linewidth]{./Figuras/EUA.pdf}
  \end{center}
  \vspace{-0.8 cm}
	\legend{Fonte: adaptado de \cite{finkelhor2013updated}.}
\end{figure}
...
Há registros de jogos com temática preventiva ao abuso sexual infantil na Austrália, França, Alemanha e Inglaterra \cite{millman2019uk}. Tal como os Estados Unidos estes países registram queda no número de casos de abuso sexual contra crianças e adolescentes. Entre os jogos ministrados aos menores cita-se: \textit{Cool and Safe}; \textit{Orbit}; \textit{Begin Safety and Smart}; e outros. Cada qual possui sua própria estrutura lúdica, no entanto os objetivos comuns de todos se assentam em três conceitos principais \cite{maria2010papel}:  
...
%Aims and Guidelines of CSA Prevention Programs (ARTIGO: http://jultika.oulu.fi/files/nbnfioulu-201808232667.pdf) = A Compiled Analysis of Child Abuse Prevention Programs for Educators
%Examining key design decisions involved in developing a serious game for child sexual abuse prevention (ARTIGO: https://sci-hub.do/10.3389/fpsyg.2014.00073)

\end{comment}

Os jogos para navegadores voltados a prevenção e combate à violencia sexual infantil, demonstram sucesso expressivo no ensino de habilidades preventivas. Os conceitos abordados por tais jogos assumem um importante papel no combate a violência sexual infantil.
...
\begin{framed}
  ...
  %RENTENÇÃO VS CONHECIMENTO (a retenção deve ser duradoura, o conhecimento pode ser temporário)
\end{framed}

%Retention of knowledge needs to be measured beyond 3–12 months (Zwi et al. 2008),
%RETENCAO MAIS DE 3 MESES
...
%O processo de validação é baseado nas \textit{Orientações técnicas internacionais de educação em sexualidade} da UNESCO \cite{women2018international}. 
...
\legend{\large\label{topicos}Objetivos Específicos}\vspace{-0.6cm}
\begin{framed}
  \begin{parcolumns}{2}
    \vspace{-0.5cm}
    \colchunk{
    \begin{itemize}\item[$\checkmark$] Anatomia \end{itemize}
    \begin{itemize}\item[$\checkmark$] Buscar ajuda e apoio \end{itemize}
    }
    \colchunk{
    \begin{itemize}[leftmargin=*]\item[$\checkmark$] Privacidade corporal \end{itemize}
    \begin{itemize}[leftmargin=*]\item[$\checkmark$] Utilização segura das TIC \end{itemize}
    }
...
Para que o programa desenvolvido seja validado, é necessário que os participantes do programa comprovem algum nível de aprendizagem sobre os conceitos abordados. No que diz respeito a parte de \textbf{anatomia}, os participantes devem ser capazes de identificar corretamente a localização e o nome das partes do corpo. Na parte de \textbf{privacidade corporal} as crianças devem saber diferenciar as partes íntimas do corpo das demais partes. Sobre a \textbf{utilização segura das TIC} os participantes devem manifestar competências sobre o uso seguro das Tecnologias da informação e comunicação. Já, no que tange a parte de \textbf{buscar ajuda e apoio} as crianças devem saber reconhecer um adulto de confiança.


\begin{itemize}
  \item os participantes devem ser capazes de identificar corretamente a localização e o nome das partes do corpo;
  \item as crianças devem saber diferenciar as partes íntimas do corpo das demais partes;
  \item os participantes devem manifestar competências sobre o uso seguro das Tecnologias da informação e comunicação;
  \item as crianças devem saber reconhecer um adulto de confiança.
\end{itemize}
\end{comment}
...
\begin{framed}
  \begin{parcolumns}{2}
    \vspace{-0.5cm}
    \colchunk{
    %\begin{itemize}\item[$\checkmark$] Os participantes devem ser capazes de identificar corretamente a localização e o nome das partes do corpo. \end{itemize}
    \begin{itemize}\item[$\checkmark$] Os participantes devem ser capazes de identificar toques ruins e toques bons no corpo. \end{itemize}
    \begin{itemize}\item[$\null$]\end{itemize}
    \begin{itemize}\item[$\checkmark$] As crianças devem saber identificar situações e pessoas perigosas e aprenderem a evitá-las. \end{itemize}
    %\begin{itemize}\item[$\checkmark$] As crianças devem saber diferenciar as partes íntimas do corpo das demais partes. \end{itemize}
    }
    \colchunk{
    \begin{itemize}\item[$\checkmark$] Os participantes devem saber utilizar corretamente as tecnologias da informação e comunicação. \end{itemize}
    \begin{itemize}\item[$\null$]\end{itemize}
    \begin{itemize}\item[$\checkmark$] As crianças devem saber reconhecer canais e formas de denúncia. \end{itemize}
    %\begin{itemize}\item[$\checkmark$] As crianças devem saber reconhecer um adulto em quem possam confiar. \end{itemize}
    }
...
\begin{citacao}\label{UNESCO}
  ...
  As Orientações também são úteis para pessoas envolvidas na \textbf{elaboração}, na \textbf{implementação} e na \textbf{avaliação} de programas de educação em sexualidade realizadas dentro e fora da escola \cite[p. 12, grifo meu]{women2018international}.%\cite[1.1]{women2018international}.
\end{citacao}

% Assim como a versão original das Orientações, esta versão revisada é facultativa, baseada nas mais recentes evidências científicas, e concebida para apoiar os países na implementação de programas eficazes de educação em sexualidade adaptados aos seus contextos. = UNESCO
...
\legend{\large\label{questoes}Questões de Pesquisa}\vspace{-0.6cm}
\begin{framed}
...
%lucidez aos gastos fixos,  


%Contudo, há demais questões que permeiam este âmbito, como: Quais profissionais irão lecionar esse programa? Onde esse programa será lecionado? Para que faixa etária o programa será destinado? Quais serão os custos do programa? %LEIA: 
...
%Cabe destacar que programas de outros países já confirmaram e validaram hipóteses muitos similares a \hyperref[hipotese]{apresentada} \cite{finkelhor2009prevention}. Contudo, as hipóteses similares se provaram válidas em países desenvolvidos. Não se achou casos na literatura que corroborassem estudos do gênero envolvendo países emergentes, tais como o Brasil. Os países emergentes apresentam uma condição socio-econômica distinta em relação aos países desenvolvidos. Por tal razão, faz-se necessário confrontar os achados dos demais estudos com a realidade brasileira. 
...
A estrutura pedagógica definida para o programa educacional para prevenção da violência sexual infantil proposto por essa pesquisa, assume a forma de um Jogo Sério\footnote{Jogos Sérios são jogos projetados para uma finalidade principal que não a pura diversão.} (JS). A abordagem pedagógica por JS foi escolhida, uma vez observados seus resultados promissores em pesquisas passadas \cite{muller2014child, fingerleabschlussbericht}. Além disso, tal abordagem ainda proporciona um sistema competente de acesso a informações positivas, confiáveis e livre de julgamentos sobre sexualidade e relacionamentos \cite{women2018international}.


%O documento da UNESCO separa seus conteúdos em 4 faixas etárias (5 a 8 anos; 9 a 12 anos; 12 a 15 anos e 15 a 18+ anos). Um programa sólido de educação sexual deve acompanhar a criança e o adolescente até sua fase adulta, preferencialmente. Deste modo, o programa proposto pelo presente trabalho almeja esse objetivo, todavia a primeira etapa do programa tem seu projeto baseado apenas nos conteúdos focados para a mais tenra idade do documento da UNESCO (5 a 8 anos). A primeira etapa do programa, será a única descrita por essa pesquisa. Cabendo a trabalhos futuros a descriação e o desenvolvimento das demais etapas. 

%A atual pesquisa fundamenta seus alicerces em um programa educacional para prevenção da violência sexual infantil inétido em carácter nacional e internacional. Nacionalmente tem-se o Projeto Saúde e Prevenção nas Escolas\footnote{O Projeto Saúde e Prevenção nas Escolas (SPE) é uma das ações do Programa Saúde na Escola (PSE), que tem a finalidade de contribuir para a formação integral dos estudantes da rede pública de educação básica por meio de ações de prevenção, promoção e atenção à saúde. Disponível em: \url{http://portal.mec.gov.br/projeto-saude-e-prevencao-nas-escolas-spe}}, contudo tal projeto não apresenta conteúdo pedagógicos de prevenção a violência sexual infantil. Também cita-se nacionalmente projetos indepentedes de educação sexual infantil\footnote{Jennifer Garrido é um professora de educação infantil que possui como um de suas aulas a importância da educação sexual nas escolas. Disponível em: \url{https://revistamarieclaire.globo.com/Comportamento/noticia/2020/08/professora-sobre-video-de-educacao-sexual-que-viralizou-se-doi-se-sente-medo-nao-e-bom.html}}. A originalidade do programa proposto por essa pesquisa, vem no sentido de ser um programa governamental para a prevenção da violência sexual infantil baseado em normas e em diretriz pedagógicas sólidas internacionalmente.


%, como o caso da professora Jennifer Garrido\footnote{Jennifer Garrido é um professora de educação infantil que possui como um de suas aulas a importância da educação sexual nas escolas. Disponível em: \url{https://revistamarieclaire.globo.com/Comportamento/noticia/2020/08/professora-sobre-video-de-educacao-sexual-que-viralizou-se-doi-se-sente-medo-nao-e-bom.html}}. Embora Jennifer ministre conteúdos de prevenção a violência sexual infantil, seu projeto não possui qualquer vínculo com escolas municipais, estaduais ou federais, sendo um projeto da iniciativa privada. A originalidade do programa proposto por essa pesquisa, vem no sentido de ser um programa governamental para a prevenção da violência sexual infantil baseado em normas e em diretriz pedagógicas sólidas internacionalmente.

%Internacionalmente, existem inúmeros programas para a prevenção da violência sexual infantil. Os programas educacionais para a prevenção da violência sexual infantil de outras nações variam consideravelmente entre si. Os programas vão desde o conceito mais tradicional de ensino, com aulas e material escolar clássico (livros e apostilas), até aulas dinâmicas e interativas com materiais audiovisuais, músicas e jogos. Embora alguns programas sejam gratuitos e de livre acesso se faz necessário desenvolver uma nova solução ao cenário brasileiro, ao invés de adaptar as soluções já existentes. Isso se faz necessário devido a inviabilidade de adaptação dos programas estrangeiros, seja por questões culturais, contextuais, burocráticas ou tecnológicas. A fim de exemplo, a fundação australiana Daniel Morcombe\footnote{A Fundação Daniel Morcombe oferece educação pessoal sobre segurança infantil para crianças e jovens, a fim de prevenir o abuso. Disponível: \url{https://danielmorcombe.com.au/}} leva o nome de um menino morto aos 13 anos por um agressor sexual. O nome do menino traz comoção a Austrália, por isso adaptar os materiais da fundação ao Brasil, poderia não traduzir o caracter emocional da causa. Além disso, a cor vermelha da camiseta usada por Daniel no dia do seu desaparecimento representa na Austrália um símbolo de segurança infantil. A cor vermelha de sua camiseta poderia ser mal intrepretada em um país polarizado politicamente ou religiosamente. Deste modo, a originalidade internacional do programa proposto por essa pesquisa vem no sentido de ser um programa totalmente adaptado e contextualizado a realidade brasileira.
...
%Em virtude da sensibilidade da temática tratada e do público alvo vulnerável do corrente trabalho, informa-se que os procedimentos técnicos da presente pesquisa foram validados pelo Comitê de Ética em dezembro de 2020, sob o protocolo nº 87266318.6.-XXXX.0118. %https://www.udesc.br/arquivos/cct/id_cpmenu/1024/dissertacao_final_15167050734725_1024.pdf
...
% Uma mesma pesquisa pode se enquadrar em várias classes (classificação).

%Uma classificação não está estanque (parada no tempo, podendo mudar).

%Não são única, não são completadas, não estão estáticas, não são excludentes (essa grande flexibilidade deixa isso tudo muito confuso)

%REFERÊNCIAS: https://www.youtube.com/watch?v=wMb2qywAMSk&t=1s&ab_channel=MarceloHounsell

%O processo de classificação da pesquisa é uma tarefa inexata. A depender da corrente metodológica, uma mesma pesquisa pode assumir inúmeras classificações. Isso pois, não há consenso terminológico sobre as classificações existentes, além de não existir acordo a respeito do escopo das mesmas. As classificações de pesquisa na área da metodologia em suma: não são únicas, não são completas, não são atemporais e não são excludentes \cite{carlos2002elaborar}. Tais características tornam o processo de classificação da pesquisa uma tarefa árdua e inexata em alguns casos. 
...
%a subseção \ref{sub:coleta} especifica as formas de coleta dos dados,
%a subseção \ref{sub:posicao} relata a posição epistemológica da presente pesquisa,
%a subseção \ref{sub:variaveis} apresenta as variáveis envolvidas no presente estudo,
...
%Nesse sentido, citam-se principalmente: as revisões sistemáticas, os levantamentos bibliográficos e as revisões do Estado-da-Arte. As revisões sistemáticas definem uma classe de pesquisa que se utilizam unicamente de referencial teórico tratado, oriundo das bases da literatura especializada. Os levantamentos bibliográficos assentam as pesquisas secundárias responsáveis por uma coleta buscam aspectos descritivos e quantitativos sem uscar uma análise do conteúdo. As revisões do Estado-da-Artes englobam as pesquisas fundamentadas em trabalhos publicados escolhem-se as publicações dos últimos 3 ou 5 anos \cite{azevedo2017revisao}.
...
%Scan: primeira leitura = passar os olhos
%Skim: segunda leitura = leitura de maior atenção nos trechos mais relevantes
%Understand: terceira leitura = leitura completa


%\subsection{Influência das Variáveis}\label{sub:variaveis}
...
%uma vez que busca-se extender os achado \hyperref[hipotese]{hipótese proposta} para um contexto mais geral. 
...
O corrente trabalho acadêmico realiza a validação do programa educacional proposto com o auxílio de dois grupos de participantes, um grupo experimental e um grupo controle. Tal abordagem é tradicionalmente associada a pesquisas experimentais. Todavia, salienta-se que os grupos selecionados pelo presente estudo não obedecem a uma distribuição aleatória (um dos fatores principais para a elaboração de pesquisas experimentais sólidas). Por tal razão a atual pesquisa se enquadra em uma classe de pesquisas experimentais conhecidas como pesquisas quase-experimentais \apud{campbell1979delineamentos}{carlos2002elaborar}.

%a seleção dos grupos deve obedecer uma distribuição aleatória para que uma pesquisa seja classificada de fato como experimental. A presente pesquisa carece de aleatoridade nos grupos selecionados, por tal razão a induzão dos resultados desta pesquisa pode não representar a realidade 


%\subsection{Posição Epistemológica}\label{sub:posicao}

%positivista, interpretivista, critica...positivista, interpretivista, critica...positivista, interpretivista, critica...positivista, interpretivista, critica...positivista, interpretivista, critica...positivista, interpretivista, critica...positivista, interpretivista, critica...positivista, interpretivista, critica...positivista, interpretivista, critica...
...
%file:///C:/Users/Windows/Documents/Mestrado%20Completo/Mat%C3%A9rias/Metodologia%20da%20Pesquisa/Trabalhos/Trabalho%206/Avalia%C3%A7%C3%B5es/Wilton%20Loch/classifica%C3%A7%C3%A3o_wilton.pdf

%\subsection{Coleta de Dados}\label{sub:coleta}

%A coleta de dados no campo da pesquisa científica se desdobra em três formas distintas de colata:  bibliográfica, campo e laboratórial. 

%questionarios, Sexuality Education Review and Assessment Tool, Likert...

%bibliografica, de campo ou de laboratorio.
...
%Ciencias Formais e Emp ˆ ´ıricas
%Ciencias Puras e Aplicadas 
%Ciencias Exatas e Inexatas 
%Ciencias Duras e Moles
%Ciencias Nomot ˆ eticas e Idiogr ´ aficas
%Livro
