...
As sequelas do abuso sexual variam de acordo com algumas condições, dentre elas: a idade da criança no início da violência; a duração e quantidade ocorrências do abuso; o nível da violência; a diferença de idade entre o agressor e a criança e o vínculo entre criança e agressor.

\cite{santos2011guia}

\cite{deslandes2016atendimento}

\cite{meurer2017direitos}

\cite{florentino2015possiveis}
