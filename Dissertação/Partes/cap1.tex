...
A definição da palavra `criança' assume significados distintos dependendo da entidade, do período ou do país. O Fundo das Nações Unidas para a Infância (em inglês: United Nations Children’s Fund - UNICEF) considera como criança todo ser humano com menos de 18 anos de idade. No Brasil, apenas as pessoas até doze anos de idade incompletos são categorizadas como crianças de acordo com o Estatuto da Criança e do Adolescente (ECA). Deste modo, afirma-se que a palavra `criança' é utilizada pelo presente trabalho com sentido equivalente as respectivas citações do paragrafo no qual a palavra se faz presente. No caso da ausência de citações bibliográficas ou indefinições etárias, assume-se a definição de `criança' da legislação brasileira. 
