...
nas salas de aula do Brasil que relatem a utilização de jogos com uma abordagem preventiva de combate ao abuso sexual infantil na literatura pesquisada.

salientando apenas a existência de iniciativas acadêmicas tais como os jogos \textbf{Infância Segura} e \textbf{CriançaProtegida}. 
...
1-) falar do problemas dos jogos atuais. (justifica o desenvolvimento - novo jogo)
2-) falar que a aplicação em territorios nacional de tais jogos deve ser vista. (será vista por essa pesquisa) [vendo contudos e maneira de apresentar os conteudos]




O Brasil possui um deficte 
...
O Brasil carece de estratégias efetivas de combate ao abuso sexual infantil 
...
no capitulo  \autoref{ch:Fundamentacao} é abordado em maiores detalhes as principais estrategias de combate a violência sexual infantil, onde será realizado um comparativo enfatizando a necessidade de traze-las a relalidade brasileita (ou desenvolver uma nova)
...
As estratégias de combate ao abuso sexual infantil devem ter como base uma política de prevenção..........
...
Dizer que o problema precisa ser tratado, justificativa/motivação (ver outros artigos)
Já preparar para iniciar a seção dos objetivos + metodologia + escopo. Questões de pesquisa. 
...
Diante do exposto, a comunicação entre surdo e ouvintes é mais uma das
dificuldades enfrentadas pelos sujeitos surdos e ouvintes. De um lado da comunicação
está o surdo com a Libras, com sua Língua própria; e do outro lado da comunicação
está o ouvinte, que na maioria dos casos não tem conhecimento básico da Língua
de sinais para que existe uma comunicação eficiente, sendo esse o problema central
desta dissertação.
...
Este trabalho de investigação procurou contribuir para melhorar as condições de aprendizagem de tecnicas de prevenção da violência sexual infantil
...
O objetivo deste trabalho é identificar como a Comunicação Aumentativa e
Alternativa em conjunto com sistemas colaborativos e dispositivos móveis podem influenciar no desenvolvimento da comunicação para pessoas com DI.
A hipótese é de que recursos mais atrativos dos dispositivos móveis, em conjunto com a mobilidade, criam oportunidades de interação e apoiam a comunicação
de pessoas com DI.... Neste contexto, este trabalho visa apoiar a comunicação da pessoa com DI, por meio do uso de dispositivos móveis e sistemas colaborativos, com a finalidade de efetivar a comunicação de pessoas com DI. Dessa forma é idealizado um sistema onde profissionais e responsáveis colaboram para o desenvolvimento da CAA personalizada para cada usuário. O sistema de CAA busca propiciar uma forma de comunicação mais efetiva e próxima à realidade do usuário, facilitando na elaboração de frases e expressão de sua comunicação.

....


O objetivo geral desse trabalho é a definição de uma estratégia de apoio à prevenção da violência sexual infantil por meio de uma tecnologia educacional. O jogo sério desenvolvido baseia-se em ‘orientações técnicas internacionais de educação em sexualidade’, as quais serviram de alicerce para a formulação dos ensinamentos do jogo. 
