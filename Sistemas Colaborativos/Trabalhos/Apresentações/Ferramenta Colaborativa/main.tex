...
\end{frame}
%[Transparência 2] Antes de começar, eu gostaria de saber: quem aqui conhece o Stack Overflow?
...
\end{frame}
%[Transparência 3] O Stack Overflow foi idealizado e desenvolvido por um programador e por um Engenheiro de Software: Joel Spolsky[esquerda] e Jeff Atwood[direita].
...
\end{frame}
%[Transparência 4] E o que de fato eles criaram? Sabemos que é uma ferramenta colaborativa, mas que tipo de ferramenta colaborativa?
...
\end{frame}
%[Transparência 5] Ok, já sabemos que é um fórum de discussão, para qual tipo de discussão? 
...
\end{frame}
%[Transparência 6] Ou seja, seu funcionamento se dá através de preguntas e respostas sem distrações.
...
\end{frame}
%[Transparência 7] Nada que possa GERAR DISCUSSÕES é aceito. Onde perguntas do tipo pode ser fechadas.
...
\end{frame}
%[Transparência 8] No caso das perguntas, é de suma importância incluir TAGS ou ETIQUETAS nas perguntas, para assim o sistema estruturar melhor todo o conteúdo gerado. Todas a perguntas devem ter etiquetas, pois toda a pergunta está relacionada a algum assunto, pelo menos: seja linguagem de programação, ou outra coisa.
...
\end{frame}
%[Transparência 9] O Stack Overflow trabalha com uma espécie de sistema de gamificação (ludificação), encorajando assim seus usuários a fazerem perguntas e a responderem perguntas. 
...
\end{frame}
%[Transparência 10] O Stack Overflow também trabalha com edições e comentários. Com as edições ajudando a polir uma determinada pergunta ou resposta. E com os comentários ajudando a esclarer outros usuários o quanto aquela resposta ajudou.
...
\end{frame}
%[Transparência 11] Por fim, o Stack Overflow trabalha também com recompensas, fornecendo medalhas aos usuários quando determinadas conquistas são alcançadas, se assemlhando mais ainda com a ideia de gamificação (ludificação).
...
\end{frame}
%[Transparência 12] Depois dessa breve introdução sobre o Stack Overflow, a pergunta que fica é: 
...
\end{frame}
%[Transparência 13] O Stack Overflow na verdade, é apenas uma parte de uma rede de mais de 170 sites de perguntas e respostas, intitulada de Stack Exchange.
...
\end{frame}
%[Transparência 14] Tudo bem que o Stack Overflow é o de maior destaque desta rede, com números gigantescos. Mas perto de outros gigantes, o Stack Overflow é bastante modesto.
